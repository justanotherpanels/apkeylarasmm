...
{
    /**
     * Store a newly created SMM Order via API.
     */
    public function store(Request $request)
    {
        ...
        // Map alias parameters from php curl
        ...
        // 2. Validate category and service exists
        ...
        // 3. Dynamic input validation based on service type
        $type = $service->type;
        $rules = [];
        ...
        // 4. Calculate amount and total price using reseller checks
        $amount = 0;
        $totalPrice = 0;
        ...
        // 7. Call SMM API Provider using PHP Native cURL
        $postFields = [
            'action' => 'add',
            'key' => $api->api_key,
            'service' => $service->pid,
        ...
        try {
            ...
            if (isset($data['status']) && $data['status'] === 'success') {
                ...
                // Deduct balance and create records transactionally
    ...
    /**
     * Retrieve SMM Order History via API.
     */
