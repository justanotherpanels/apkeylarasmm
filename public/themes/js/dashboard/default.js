...
var options = {
  series: [{
      name: 'Spending ($)',
      data: (typeof window.chartTimelineData !== 'undefined') ? window.chartTimelineData : [
          [1327359600000, 65.95],
          [1327446000000, 65.34],
          [1327532400000, 65.18],
          [1327618800000, 65.05],
  ...
  xaxis: {
      type: 'datetime',
      min: (typeof window.chartTimelineMinTime !== 'undefined') ? window.chartTimelineMinTime : new Date('01 Apr 2012').getTime(),
      max: (typeof window.chartTimelineMaxTime !== 'undefined') ? window.chartTimelineMaxTime : undefined,
      tickAmount: 6,
      axisTicks: {
          show: false,
      },
