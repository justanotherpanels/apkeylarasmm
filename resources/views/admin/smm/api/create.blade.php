            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Form Tambah Provider SMM</h5>
                        <span>Lengkapi formulir di bawah ini untuk menambahkan koneksi API Provider baru.</span>
                    </div>
                    <div class="card-body">
                        <form class="theme-form" action="{{ url('admin/smm/api') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="balance">Balance Awal (Opsional)</label>
