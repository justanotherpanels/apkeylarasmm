...
<div class="container-fluid px-4">
    <h1 class="mt-4">Edit API Provider</h1>
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Form Edit Provider SMM
        </div>
        <div class="card-body">
            <form action="{{ url('admin/smm/api/'.$api->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label" for="balance">Balance Provider ($)</label>
