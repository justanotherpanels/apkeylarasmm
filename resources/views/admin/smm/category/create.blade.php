            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Form Tambah Kategori SMM</h5>
                        <span>Lengkapi formulir di bawah ini untuk menambahkan kategori layanan baru.</span>
                    </div>
                    <div class="card-body">
                        <form class="theme-form" action="{{ route('admin.smm.category.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
