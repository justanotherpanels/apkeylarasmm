            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Form Tambah Platform</h5>
                        <span>Lengkapi formulir di bawah ini untuk menambahkan platform sosial media SMM baru.</span>
                    </div>
                    <div class="card-body">
                        <form class="theme-form" action="{{ route('admin.smm.platform.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="name">Nama Platform</label>
                                        <input class="form-control" id="name" name="name" type="text" placeholder="Masukkan nama platform (Contoh: Instagram)" value="{{ old('name') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="icon_imagekit_url" name="icon_imagekit_url" type="url" placeholder="https://ik.imagekit.io/your_id/platform/instagram.png" value="{{ old('icon_imagekit_url') }}">
                            ...
                            <div class="card-footer text-end px-0 pb-0">
                                <button class="btn btn-primary" type="submit">Simpan Platform</button>
