            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Form Tambah Layanan SMM</h5>
                        <span>Lengkapi formulir di bawah ini untuk menambahkan layanan SMM baru.</span>
                    </div>
                    <div class="card-body">
                        <form class="theme-form" action="{{ route('admin.smm.service.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
